...
def index():
    ...
    return render_template('fuckingip.html', ip=data1,address=data3,hostname=data3,lat=loc_data['lat'],lon=loc_data['lng'],isp=loc_data['org'],isp_url="https://ipinfo.io/"+loc_data['org'].split(" ")[0],zipcode=loc_data['postal'])
